...
#PBS -l nodes=1:ppn=12,walltime=08:00:00,mem=8000mb
...
#echo $paramfile_base
matlab -nosplash -nodisplay -nodesktop -r "infer_events_caller(${paramfile_base})" > matlab-output/matoutfile-${PBS_JOBID}
#-${paramfile_base}

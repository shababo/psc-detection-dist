function [newSpikeTrain, newCalcium, newLL, tmp] = add_event(oldSpikeTrain,oldCalcium,oldLL,filter,amp,tau,obsCalcium,timeToAdd,indx)
    ...
    wk_h = amp*exp((timeToAdd - ceil(timeToAdd))/tau_h);
    wk_d = amp*exp((timeToAdd - ceil(timeToAdd))/tau_d);    

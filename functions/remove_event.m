function [newSpikeTrain, newCalcium, newLL, tmp] = remove_event(oldSpikeTrain,oldCalcium,oldLL,filter,amp,tau,obsCalcium,timeToRemove,indx)
    ...
    wk_h = amp*exp((timeToRemove - ceil(timeToRemove))/tau_h);
    wk_d = amp*exp((timeToRemove - ceil(timeToRemove))/tau_d);
